...
class TransformerDecoderMLP(nn.Module):
    """
    Conventional Transformer Decoder architecture with intact MLP FFN.
    Constructor kept compatible with:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train/Evaluate conventional Transformer Decoder (MLP) on Tiny Shakespeare."
    )
    ...
    # Keep model defaults aligned with current KAN script for fair comparison.
...
def main() -> None:
    ...
    model_class = TransformerDecoderMLP
    model = model_class(
    ...
    print("\n=================================================")
    print("MODEL: Transformer Decoder - MLP architecture")
    print("=================================================")
    print(f"Total Parameters: {total_params:,}")
    print(f"Trainable Parameters: {trainable_params:,}\n")
