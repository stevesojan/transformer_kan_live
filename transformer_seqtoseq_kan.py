...
UNK_TOKEN = "<UNK>" #placeholder for unkown tokens i.e not available in the training set
...
class TransformerSeq2SeqKAN(nn.Module):
    """
    Transformer Seq2Seq Encoder-Decoder where both encoder and decoder FFN blocks
    are replaced by KAN feed-forward modules.
    """
    ...
    def __init__(
        ...
        decoder_layer = TransformerDecoderLayerKAN(
            d_model=d_model,
            nhead=nhead,
            kan_hidden_dim=kan_hidden_dim,
            dropout=dropout,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train/Evaluate Transformer Seq2Seq Encoder-Decoder KAN pair on Tiny Shakespeare."
    )
...
def main() -> None:
    ...
    model_class = TransformerSeq2SeqKAN
    model = model_class(
    ...
    print("\n=================================================")
    print("MODEL: Transformer Seq-to-Seq Encoder Decoder KAN Pair")
    print("=================================================")
    print(f"Total Parameters: {total_params:,}")
    print(f"Trainable Parameters: {trainable_params:,}\n")
